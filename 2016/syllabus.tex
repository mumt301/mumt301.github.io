...
% \item September 24th: Masataka Goto, National Institute of Advanced Industrial Science and Technology (AIST), Japan@CIRMMT \href{http://www.cirmmt.org/activities/distinguished-lectures/goto}{``Frontiers of music technologies: Singing synthesis and active music listening''} 

% \item September 27th: Music and Genre: New Directions Conference ``Digital Genre Machines: Between the Dissolution and the Reification of Genre''. MIR sessions from 13:30 to 18:15. 

% \item September 29th: ``Workshop on SIMSSA (Single Interface for Music Score Searching and Analysis) IV''
% \item September 30th: Douglas Eck's CIRMMT Distinguished Lecture  ``Music recommendation and discovery at scale''
\end{itemize}
